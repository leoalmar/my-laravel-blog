...
angular.module('services.events', ['ngResource'])

.factory('EventsService', function ($resource,$http){
...
angular.module('services.images', ['ngResource'])

.factory('ImagesService', function ($resource,$http){
...
angular.module('services.mines', ['ngResource'])

.factory('MinesService', function ($resource,$http){
...
angular.module('services.partners', ['ngResource'])

.factory('PartnersService', function ($resource,$http){

	var URL = "/admin/partners";
...
angular.module('services.projects', ['ngResource'])

.factory('ProjectsService', function ($resource,$http){
...
angular.module('services.regions', ['ngResource'])

.factory('RegionsService', function ($resource,$http){

	var URL = "/admin/regions";
